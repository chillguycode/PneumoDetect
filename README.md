...
[![Backend CI Pipeline](https://github.com/chillguycode/PneumoDetect/actions/workflows/tests.yml/badge.svg)](https://github.com/chillguycode/PneumoDetect/actions/workflows/tests.yml)


#### 🔗 **Live Demo:** [pneumodetect-493921.web.app](https://pneumodetect-493921.web.app)
...
> Model trained and evaluated on the 
> [Kermany et al. Chest X-Ray Dataset (Cell, 2018)](https://www.cell.com/cell/fulltext/S0092-8674(18)30154-5) 
> - 5,856 clinically validated pediatric chest X-ray images 
> across NORMAL and PNEUMONIA classes.

> Base architecture: [EfficientNetV2-S](https://arxiv.org/abs/2104.00298) 
> (Tan & Le, ICML 2021), fine-tuned for binary chest X-ray classification.

---

## 🔬 PneumoCam: EigenCAM Explainability
...
![PneumoCam Example](./assets/xray_comparison.png)
...
> EigenCAM: [Muhammad & Yeasin, 2020](https://arxiv.org/abs/2008.00299) 
